...
Published topics:
  ~/joint_states       (sensor_msgs/JointState)  namespaced
...
class PanTiltNode(Node):
    ...
    def __init__(self):
        ...
        # Namespaced publisher (reliable) for direct subscribers
        self._js_pub = self.create_publisher(JointState, '~/joint_states', qos_reliable)

        # Global publisher (best effort) for robot_state_publisher
